...
| [ai_llm/skills/scode/](ai_llm/skills/scode/) | Bug bounty workflow — 5 phases, 22 vulnerability scanners (web + web3) | Structured prompts |
| [ai_llm/skills/ptest/](ai_llm/skills/ptest/) | Pentest framework with gateway-gated phase progression | Structured prompts |
| [ai_llm/skills/parse-finding/](ai_llm/skills/parse-finding/) | Security finding → Jira-ready report converter | Structured prompts |
