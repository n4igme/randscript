...
**Reference:** `references/ghidramcp-api.md`, `references/native-ssl-pinning-analysis.md`, `references/frida-scripting.md`, `references/debugger-workflows.md`, `references/unknown-binary-triage.md`
