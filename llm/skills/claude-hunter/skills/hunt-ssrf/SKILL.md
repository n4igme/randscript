---
name: hunt-ssrf
description: Hunting skill for ssrf vulnerabilities. Built from 9 public bug bounty reports. Includes 11 IP bypass techniques (decimal, octal, hex, short IP, IPv6, DNS rebinding, redirect chain, URL parser confusion, CNAME, rare format), cloud metadata payloads, injection points, and impact chain escalation. Use when hunting ssrf on any target.
