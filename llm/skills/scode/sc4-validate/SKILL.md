---
name: sc4-validate
description: "Step 4 of bug bounty workflow. Validate vulnerability findings by re-reading code, confirming data flows, and eliminating false positives. Outputs validated-vulnerabilities.md."
allowed-tools: Read Bash(find *) Bash(grep *) Bash(head *) Bash(cat *) Bash(ls *) Write
argument-hint: <path to vulnerabilities.md, defaults to ./assessment/vulnerabilities.md>
---
