---
name: vuln-web3-aa
description: "Step 3w-j of bug bounty workflow. Scan for Account Abstraction (ERC-4337) vulnerabilities (paymasters, bundlers, smart accounts). Appends to vulnerabilities.md."
